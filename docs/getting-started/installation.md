...
=== "Linux (arm64)"
    ...
    ```bash
    curl -L https://github.com/mur-run/mur-cli/releases/latest/download/mur-linux-arm64.tar.gz | tar xz
    sudo mv mur /usr/local/bin/
    ```

=== "Windows"

    Download `mur-windows-amd64.zip` from the [releases page](https://github.com/mur-run/mur-cli/releases/latest) and extract to a directory in your PATH.
