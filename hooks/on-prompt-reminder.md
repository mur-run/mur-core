...
1. Create a file in ~/clawd/skills/murmur-ai/learned/{domain}/{category}/
   - domain: _global, devops, web, mobile, backend, data
   - category: debug, pattern, style, security, performance, ops
   - For project-specific: ~/clawd/skills/murmur-ai/learned/projects/{project-name}/{category}/
...
- For personal/private patterns: ~/clawd/skills/murmur-ai/learned/personal/{your-name}/{category}/
