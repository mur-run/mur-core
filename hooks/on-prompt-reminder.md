...
1. Create a file in ~/clawd/skills/claude-code-learner/learned/{domain}/{category}/
   - domain: _global, devops, web, mobile, backend, data
   - category: debug, pattern, style, security, performance, ops
   - For project-specific: ~/clawd/skills/claude-code-learner/learned/projects/{project-name}/{category}/
